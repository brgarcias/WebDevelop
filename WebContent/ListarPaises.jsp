...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
			...
			<script src="https://kit.fontawesome.com/d2ccd95e42.js" crossorigin="anonymous"></script>
                    ...
                    <div id="top" class="row">
                        ...
                        <div class="col-md-6">
                            <div class="input-group h2">
                				...
                				<button class="btn btn-info" type="submit" name="command" value="ListarPaisesBuscar" style="margin-bottom: 10px;">
                        ...
                        <div class="col-md-3">
                            <a href="CriarPais.jsp" class="btn btn-info pull-right h2">Novo País</a>
                        </div>
                    </div>
                    <!-- /#top -->
                </form>
